"""
Django settings for scipo project.
...
from secrets import secret_key, oidc_rp_client_id, oidc_rp_client_secret
...
WSGI_APPLICATION = 'scipo.wsgi.application'
